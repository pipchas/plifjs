...
async function loadCurrState(){
  console.log(graph, 'dfmklfmkldsmklfmjklds')
  console.log(curr_state, 'IDIDIDIDi')
  //тут берет мапу в  которой по айдишникам лежит каждая степ трасса и вкидывает ее для рисования
...
function drawNewTrace(stateStr){
  let content = document.getElementById("trace");
  drawTrace(content, stateStr);
}

function drawNewState(stateStr){
  let content = document.getElementById("content-next");
